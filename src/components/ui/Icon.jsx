...
const PATHS = {
  ...
  pencil: ['M4 20h4L19 9a2.83 2.83 0 0 0-4-4L4 16v4z', 'M14.5 5.5l4 4'],
  scribble: ['M3 16c1.6-5 3-5 4-1s2 5 3.2 1.2S12.6 9 14 12s2.4 4 3.4 1.2S19.6 9 21 10'],
  square: ['M5 5h14v14H5z'],
  arrowUpRight: ['M7 17L17 7', 'M9 7h8v8'],
  type: ['M5 6h14', 'M12 6v12', 'M9 18h6'],
  blackoutBar: ['M3 9h18v6H3z', 'M6 9l2.5 6M11 9l2.5 6M16 9l2.5 6'],
